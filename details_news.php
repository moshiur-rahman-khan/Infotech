...
<?php } ?>
                ...
                <div class="row">
                    <div style="margin-right:70px"> 
                        <center>
                            <legend style="background-color:#9e2929;padding-right:20px ">
                    ...
                    <div class="col-md-11">
                        <form method="post" style="border: 1px solid gray; padding: 20px; font-size: 20px;color: #402327;background-color: #9A141D">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="commentator_name" name="commentator_name" placeholder="Commentator Name"/>
                            </div>
