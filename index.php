                    ...
                    <div class="col l9 col m12 col s12">
                        ...
                        <div class="pgwSlider wide">
                            <div class="ps-current" style="height: 540px;">
                                <ul><li class="elt_1" style="opacity: 1; z-index: 2; display: list-item;"><a href="javascript:void(0);"><img src="./images/hor-news2.jpg" alt=" <a href=" javascript:void(0);"=""     I N F O T E C H . C O M"&gt;</a></li>
                                    <li class="elt_2" style="opacity: 0; display: none; z-index: 1;"><a href="javascript:void(0);"><img src="./images/hor-news3.jpg" alt="<a href=" javascript:void(0);"=""> Party,s Over for frat after ski-resort rampage "&gt;</a></li><li class="elt_3" style="opacity: 0; display: none; z-index: 1;"><a href="javascript:void(0);"><img src="./images/hor-news4.jpg" alt="<a href=" javascript:void(0);"=""> Reeling Fashion Police gets Sidelined "&gt;</a></li></ul><span class="ps-caption" style="display: inline;"><div class="news-time"><i class="fa fa-clock-o"></i>21 Mins Ago</div><h2> <a href="javascript:void(0);">ক্যামেরা এবং সেলফি তোলার জন্য বেষ্ট কিছু এন্ড্রয়েড অ্যাপস</a> </h2><p>আমাদের দৈনন্দিন জীবনের টুকটাক ফটোগ্রাফির জন্য আমরা অনেকেই এখন আমাদের স্মার্টফোনকেই বেছে নেই।তাই এখন স্মার্টফোন কেনার আগে বেশিরভাগই এর ক্যামেরার দিকে বেশি গুরুত্ব দেয়।আমাদের স্মার্টফোনে বিল্ট-ইন ক্যামেরা অ্যাপ রয়েছে, তবে তাতে রয়েছে কিছু সীমাবদ্ধতা।তাই আমরা অনেক রকমের থার্ডপার্টি অ্যাপস ব্যবহার করি যা আমাদের সেইসব সীমাবদ্ধতা অনেকটাই দূর করে থাকে। </p></span></div>
                            ...
                            <div class="news horizontal">
                                ...
                                <div class="col l8 col m8 col s12 no-padding">
                                    ...
                                    <div class="news-description">
                                        ...
                                        ?>
                                        <?php echo "Category-".$row_category['category_name']."  "; echo "Sub Category-".$row_sub_category['sub_cat_name']; }
                                            }?>
                                        </div>
